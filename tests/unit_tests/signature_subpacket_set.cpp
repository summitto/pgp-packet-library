...
TEST(signature_subpacket_set, constructor)
{
...

    {
        ...
        ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(sss[0]), p1);
        ASSERT_EQ(pgp::get<pgp::signature_subpacket::primary_user_id>(sss[1]), p2);
        ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(sss[2]), p3);
...
TEST(signature_subpacket_set, iterators)
{
    ...
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(*sss.begin()), p1);
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(*sss.cbegin()), p1);
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(*sss.rbegin()), p3);
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(*sss.crbegin()), p3);
...
TEST(signature_subpacket_set, encode_decode)
{
    ...
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(sss[0]).data(), p1.data());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::primary_user_id>(sss[1]).data(), p2.data());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(sss[2]) == p3, true);
}
...
TEST(signature_subpacket_set, decode_all)
{
    ...
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::unknown>(sss2[0]).type(), p1.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(sss2[1]).type(), p2.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::signature_creation_time>(sss2[2]).type(), p3.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::signature_expiration_time>(sss2[3]).type(), p4.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::exportable_certification>(sss2[4]).type(), p5.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::primary_user_id>(sss2[5]).type(), p6.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_expiration_time>(sss2[6]).type(), p7.type());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(sss2[7]).type(), p8.type());
}
...
TEST(signature_subpacket_set, data)
{
    ...
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::issuer>(sss.data()[0]).data(), p1.data());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::primary_user_id>(sss.data()[1]).data(), p2.data());
    ASSERT_EQ(pgp::get<pgp::signature_subpacket::key_flags>(sss.data()[2]) == p3, true);
}
